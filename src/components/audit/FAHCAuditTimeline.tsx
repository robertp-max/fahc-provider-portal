...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  demo_role_switched: 'Switched demo role',
  listing_submitted: 'Submitted listing for review',
  listing_approved: 'Approved listing',
  listing_rejected: 'Rejected listing',
  listing_reverted_to_draft: 'Reverted listing to draft',
  admin_revenue_reviewed: 'Reviewed revenue submission (admin)',
  document_reviewed: 'Reviewed onboarding document (admin)',
